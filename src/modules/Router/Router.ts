...
class Router {
     ...
     */
    constructor() {
        // @ts-expect-error ts-migrate(2339) FIXME: Property '_root' does not exist on type 'Router'.
        ...
        // @ts-expect-error ts-migrate(2339) FIXME: Property '_routes' does not exist on type 'Router'... Remove this comment to see the full error message
        this._routes = {};
     ...
     */
    register(template: any, view: any) {
    ...
    start() {
        // @ts-expect-error ts-migrate(2339) FIXME: Property '_root' does not exist on type 'Router'.
        this._root.addEventListener('click', (event: any) => {
     ...
     */
    registerNotFound(notFoundView: any) {
     ...
     */
    getPathParams(path: any, template: any) {
        ...
        return templateElements.every((part: any, index: any) => {

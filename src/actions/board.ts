...
export const boardActions = {
     ...
     */
    updateBoardTitleDescription(boardName: string, description: string) {
        Dispatcher.dispatch({
     ...
     */
    hideConfirmDeleteBoard(confirmed: boolean) {
        Dispatcher.dispatch({
     ...
     */
    refreshUserSearchList(searchString: string) {
        Dispatcher.dispatch({
     ...
     */
    toggleUserInSearchList(uid: number) {
        Dispatcher.dispatch({

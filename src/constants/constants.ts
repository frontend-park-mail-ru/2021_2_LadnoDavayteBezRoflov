...
export const HTTP = {
    SelfAddress: {
        // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'FRONTEND_ADDRESS'.
        Url: FRONTEND_ADDRESS,
        // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'FRONTEND_PORT'.
        Port: FRONTEND_PORT,
    },
    BackendAddress: {
        // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'BACKEND_ADDRESS'.
        Url: BACKEND_ADDRESS,
        // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'BACKEND_PORT'.
        Port: BACKEND_PORT,
    },
    // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'SCHEME'.
    Scheme: SCHEME,
};
...
export const ServiceWorker = {
    ...
    API_PREFIX: '/api',
    // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'APP_VERSION'.
